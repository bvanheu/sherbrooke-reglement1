...
TODAY=$(date +"%Y_%m_%d")
REGLEMENT1_URL=$(curl "http://www.ville.sherbrooke.qc.ca/services-municipaux/service-des-affaires-juridiques/reglements/" 2> /dev/null | grep -oh 'fileadmin[a-zA-Z\/.]*reglement1[a-zA-Z\/\._ 0-9-]*')
...
curl -o "$REGLEMENT1_FILENAME" "$REGLEMENT1_FULL_URL"
